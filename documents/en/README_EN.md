...
> [Chinese Version](https://github.com/Jacknoms/vauwgj/blob/master/README.md)

- [Cloudflare Optimization Solution](https://github.com/Jacknoms/vauwgj/blob/master/documents/optimize_V2Ray.md)
- [Traffic Relay](https://github.com/Jacknoms/vauwgj/blob/master/documents/traffic_relay.md)
- [manual self-build tutorial](https://github.com/Jacknoms/vauwgj/blob/master/documents/Cloudflare_install_manual.md)
...
- [Cloudflare Getting Started Tutorial](https://github.com/Jacknoms/vauwgj/blob/master/documents/cloudflare_init.md)
...
- Support any combination of installation, support for multi-user management, support for DNS streaming media unlock, support for adding multiple ports, [support any door to unlock Netflix](https://github.com/Jacknoms/vauwgj/blob/master/documents/netflix/dokodemo-unblock_netflix.md)
- support to keep tls certificate after uninstall
- support for IPv6, [IPv6 note](https://github.com/Jacknoms/vauwgj/blob/master/documents/ipv6_help.md)
...
- [Support custom certificate installation](https://github.com/Jacknoms/vauwgj/blob/master/documents/install_tls.md)
...
- **If you use CDN and direct connection at the same time, turn off Yunduo + self-selected IP, refer to the above [Cloudflare optimization plan](https://github.com/Jacknoms/vauwgj/blob/master/documents/optimize_V2Ray.md)**
...
- wget: command not found [**Here you need to do it manually Install wget**]
  , if you have not used Linux, [click to view](https://github.com/Jacknoms/vauwgj/tree/master/documents/install_tools.md) installation tutorial
...
- **[If you don't understand the usage, please check the script usage guide first](https://github.com/Jacknoms/vauwgj/blob/master/documents/how_to_use.md)**
...
- ** The problem that the lower version script cannot be started when upgrading the higher version, [please click this link to view the solution](https://github.com/Jacknoms/vauwgj/blob/master/documents/how_to_use.md#4%E4%BD%8E%E7%89%88%E6%9C%AC%E5%8D%87%E7%BA%A7%E9%AB%98%E7%89%88%E6%9C%AC%E5%90%8E%E6%97%A0%E6%B3%95%E5%90%AF%E5%8A%A8%E6%A0%B8%E5%BF%83)**
...
``` 
wget -P/root -N --no-check-certificate "https://raw.githubusercontent.com/Jacknoms/vauwgj/master/shell/install_en.sh" && mv /root/install_en.sh /root/install.sh && chmod 700 /root/install.sh &&/root/install.sh
``` 
